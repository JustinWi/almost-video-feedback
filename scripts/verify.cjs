...
['src/offscreen/offscreen.html', 'src/offscreen/offscreen.js', 'src/popup/popup.js', 'src/options/options.js', 'src/history/history.html', 'src/history/history.js', 'src/common/zip.js', 'src/recognizer/recognizer.html', 'src/recognizer/recognizer.js', 'src/common/transcript.js'].forEach((p) => {
  if (exists(p)) ok(p);
  else bad('missing: ' + p);
});
